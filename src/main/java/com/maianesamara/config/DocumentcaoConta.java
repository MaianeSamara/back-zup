package com.maianesamara.config;
...
@Configuration
@EnableSwagger2
public class DocumentcaoConta implements WebMvcConfigurer {

	@Bean
	public Docket apiDocket() {
		TypeResolver typeResolver = new TypeResolver();
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.maianesamara.resource")).build()
	...
	public ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Contas - Desafio ZUP").description("Desafio ZUP Contas").version("1")
				.contact(new Contact("Desafio ZUP - Contas", "", "maianesamara@gmail.com")).build();
	}
